...
define('subtide/controllers/settings', ['exports'], function (exports) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        block(env, morph1, context, "link-to", ["settings"], {}, child1, null);
...
define('subtide/templates/settings', ['exports'], function (exports) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      build: function build(dom) {
        ...
        var el5 = dom.createTextNode("YOUR ACCOUNT INFORMATION");
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode("\n  ");
      ...
      render: function render(context, env, contextualElement) {
        ...
        var morph3 = dom.createMorphAt(dom.childAt(element0, [7, 1]),0,0);
        content(env, morph0, context, "email");
        content(env, morph1, context, "username");
        content(env, morph2, context, "firstName");
        content(env, morph3, context, "lastName");
        return fragment;
      }
    };
  }()));
...
define('subtide/tests/controllers/settings.jshint', function () {

  'use strict';

  module('JSHint - controllers');
  test('controllers/settings.js should pass jshint', function() { 
    ok(false, 'controllers/settings.js should pass jshint.\ncontrollers/settings.js: line 1, col 16, \'Ember\' is not defined.\ncontrollers/settings.js: line 3, col 10, \'appStrap\' is not defined.\ncontrollers/settings.js: line 4, col 13, \'appStrap\' is not defined.\ncontrollers/settings.js: line 5, col 14, \'appStrap\' is not defined.\ncontrollers/settings.js: line 6, col 13, \'appStrap\' is not defined.\n\n5 errors'); 
  });
...
if (runningTests) {
  ...
  require("subtide/app")["default"].create({"name":"subtide","version":"0.0.0.8d0771e5"});
}
